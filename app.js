    (function() {
        ...
        function addScript(strategyNumber, angleNumber) {
            ...
            scriptSubbox.querySelector('.add-row-link').addEventListener('click', (e) => {
                e.preventDefault();
                addScriptRow(scriptSubbox);
            });
            scriptSubbox.querySelector('.add-column-dropdown').addEventListener('click', (e) => {
                if (e.target.tagName === 'A') {
                    e.preventDefault();
                    addScriptColumn(scriptSubbox, e.target.dataset.column);
                }
            });
